        ...
        <table class="card-table table">
            ...
            ?>
                ...
                if (isset($tipo)){
                    if ($hoy >= $fecha or $tipo == "admin"){
                    ?>
                        <a class="btn primary" href="Merito.php?var=<?php echo $var?>" ><svg width="1.3em" height="1.3em" viewBox="0 0 16 16" class="bi bi-file-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
