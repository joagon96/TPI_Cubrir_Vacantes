  ...
  <div class="row">
    <div class="col-md-4 " >
      <div class="container" style="height:100%; background-color: #e9ecef">
        ...
        <p><img class="image-responsive" style="height:400px; width:100% " src="https://www.frro.utn.edu.ar/fotonoticias/100001223_2020_adr_charla_ciberseguridad_vertical.jpg" alt="imagen_anuncio" ></p>
    ...
    <div class="col-md-4">
      <div class="container" style="height:100%; background-color: #e9ecef" height="100%">
        ...
        <p style="text-align:center" ><img src="https://www.frro.utn.edu.ar/fotonoticias/100001222_convocatoria-daad2022.jpeg" alt="imagen_anuncio" width="70%"></p>
        <br>
